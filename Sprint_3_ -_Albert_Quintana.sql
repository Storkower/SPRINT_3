...
-- Introduir les deades dels usuaris a la taula
...
*/
-- control de les dades que hi ha abans del canvi
SELECT *
FROM credit_card
WHERE id='CcU-2938';
...
-- verificació del canvi realitzat
SELECT *
FROM credit_card
WHERE id='CcU-2938';
...
-- comprovació de la taula transaction i els camps que inclou
SELECT *
FROM transaction
LIMIT 1;

-- afegir les dades proporcionades SOLUCIONAR EL PROBLEMA
INSERT INTO transaction (id, credit_card_id, company_id, user_id, lat, longitude, amount, declined)
VALUES ('108B1D1D-5B23-A76C-55EF-C568E49A99DD', 'CcU-9999', 'b-9999', '9999','829.999','-117.999','111.11','0');

-- comprovació de les dades afegides a la taula
SELECT *
FROM transaction
WHERE id='108B1D1D-5B23-A76C-55EF-C568E49A99DD';

/* Dades proporcionades per la Sra. Oliveira per provocar l'error i solucionar-ho. 
Dades a afegir a la taula "transaction":
(id, credit_card_id, company_id, user_id, lat, longitude, amount, declined)
('108B1D1D-5B23-A76C-55EF-C500E49A99DD', 'CcU-0000', 'b-0000', '0000','829.999','-117.999','111.11','0')
*/

-- Primer buscaré a veure si existeixen.
INSERT INTO transaction (id, credit_card_id, company_id, user_id, lat, longitude, amount, declined)
VALUES ('108B1D1D-5B23-A76C-55EF-C500E49A99DD', 'CcU-0000', 'b-0000', '0000','829.999','-117.999','111.11','0');
...
-- comprovació de la taula credit_card i les seves columnes
SELECT *
FROM credit_card
LIMIT 1;
...
-- comprovació que s'ha eliminat la columna de la taula
SELECT *
FROM credit_card
LIMIT 1;
...
-- comprovació que hi ha el registre que es vol suprimir
SELECT *
FROM transaction
...
-- comprovar que la query funciona abans de crear la vista

SELECT 	c.company_name AS Nom_de_la_companyia,
		c.phone AS Telèfon_de_contacte,
        c.country AS País_de_residència,
        AVG(t.amount) AS Mitjana_de_compra
FROM company AS c
...
-- verificació funcionament vista
SELECT *
FROM vistamarketing;
...
WHERE País_de_residència = 'Germany';
...
/* Hem de realitzar les següents modificacions a les diferents taules (els noms que indico de les taules / columnes fa referència al meu punt de partida):*/
-- •	Taula “company”.
-- o	Eliminar la columna “website”
ALTER TABLE company
DROP COLUMN website;

-- Comprovació eliminació columna
SELECT *
FROM company
LIMIT 1;
...
-- •	Taula “credit_card”.
-- o	Afegir columna nova “fecha_actual” amb tipus de dada DATE.
ALTER TABLE credit_card
ADD fecha_actual DATE;

-- Comprovació que s'ha afegit columna
SELECT *
FROM credit_card
LIMIT 1;

-- •	Taula “user”.
-- o	Modificar el nom de la taula per “data_user”.
RENAME TABLE user TO data_user;

-- o	Modificar el nom de la columna “email” per “personal_email”.
...
SELECT 	t.id AS ID_transacció,
		...
		cc.iban AS IBAN_targeta_crèdit_usada,
		c.company_name AS Nom_companyia_transacció_realitzada,
        u.country AS Pais_usuari,
